 ...
 */
open class IdentityChangeContactComponent(
     ...
     */
    enum class Operation(val rqType: IdentityChangeContactGetCodeRq.Operation) {
    ...
    enum class ProfileContactTypeEnum(val rqType: IdentityChangeContactGetCodeRq.ContactType) {
        EMAIL(IdentityChangeContactGetCodeRq.ContactType.EMAIL), PHONE(IdentityChangeContactGetCodeRq.ContactType.PHONE)
    }
