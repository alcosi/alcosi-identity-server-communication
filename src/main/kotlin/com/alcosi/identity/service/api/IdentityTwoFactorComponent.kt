 ...
 */
open class IdentityTwoFactorComponent(
     ...
     */
    open fun checkStatus(token: String): IdentityDomainTwoFaStatus {
        try {
            return restClient
                .get()
                .uri(checkUri)
     ...
     */
    open fun get2faCode(id: String): IdentityDomainTwoFaCode {
        try {
            return restClient
                .get()
     ...
     *     code.
     */
    open fun activateTOTPGenerateCode(token: String): IdentityDomainTOTPSharedKey {
        try {
            val code =
                restClient
                    .get()
     ...
     */
    open fun recoveryTOTPCodes(token: String): List<String> {
        try {
            val code =
                restClient
                    .post()
     ...
     */
    open fun removeTOTPCodes(token: String) {
        try {
            restClient
                .delete()
                .uri(activateUri)
